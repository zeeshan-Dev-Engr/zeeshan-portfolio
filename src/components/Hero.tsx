...
const Hero = () => {
  ...
  return (
    <section id="hero" className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="w-full flex flex-col items-center justify-center mt-8 mb-2 lg:hidden">
        <div 
          ref={containerRef}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center min-h-screen w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-1 lg:gap-12 items-center w-full">
          {/* Content */}
          <motion.div
